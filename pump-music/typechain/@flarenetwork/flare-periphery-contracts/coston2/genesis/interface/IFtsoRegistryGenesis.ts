...
export interface IFtsoRegistryGenesisInterface extends Interface {
  getFunction(nameOrSignature: "getFtsos"): FunctionFragment;
...
export interface IFtsoRegistryGenesis extends BaseContract {
  connect(runner?: ContractRunner | null): IFtsoRegistryGenesis;
