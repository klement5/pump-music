...
export interface BnbMemecoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FEE_PERCENTAGE"
      | "MAX_SUPPLY"
  ...
  encodeFunctionData(
    functionFragment: "artistRegistry",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "spotifyId", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "spotifyId", data: BytesLike): Result;
...
export interface BnbMemecoin extends BaseContract {
  connect(runner?: ContractRunner | null): BnbMemecoin;
  waitForDeployment(): Promise<this>;

  interface: BnbMemecoinInterface;
  ...
  TOKEN_PRICE: TypedContractMethod<[], [bigint], "view">;
  ...
  artistRegistry: TypedContractMethod<[], [string], "view">;
  ...
  spotifyId: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "artistRegistry"
